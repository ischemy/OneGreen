        ...
        <div className="d-flex justify-content-center mt-100">
          <div className="card bg-login border-0" width={550} height={494}>
            ...
            <div className="card-body pl-48 pr-48">
              ...
              <p className="text-center text-blue pt-16 text-regular">
                Lupa Password
              </p>
              <button className="text-center btn-login text-white border-0 text-semibold br-12">
                Masuk
              </button>
              <div className="d-flex">
                <hr className="border-gray" width={206} />
                <div className="divider-text atau-color pl-8 pr-8 text-regular">
                  Atau
                </div>
                <hr className="border-gray" width={206} />
              </div>
              <button className="text-center btn-regis text-green text-semibold br-12">
                Registrasi
              </button>
            </div>
          </div>
